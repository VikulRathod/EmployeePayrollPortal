...
namespace IdentitySample.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //var resut = from u in UserManager.Users
            //            join e in db.Employees
            //            on u.Id equals e.UserId
            //            select new { Id = u.Id, UserName = u.UserName, Email = u.Email, FullName = e.FullName };
        ...
        public ActionResult UserDetails(string email)
        {
            ...
            var userId = db.AspNetUsers.FirstOrDefault(u => u.Email.Equals(email))?.Id;
